...
def registrar_backup(app: Flask):
    """Registra un comando CLI en Flask para crear respaldos de base de datos.

    Registra el comando 'flask backup' que crea un respaldo SQL de la base de datos.
    ...
    def backup_command():
        ...
        env = (
            os.environ.copy()
        )  # con copia para no afectar otras variables de entorno
        env["PGPASSWORD"] = (
